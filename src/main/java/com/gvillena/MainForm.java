...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        // 
        TelefonoMovil[] listaClaro;
        PlanPostPago[] listaPlanes;
        ...
        for (int i = 0; i < listaPlanes.length; i++) {                        
            ListaPPClaro.add(listaPlanes[i]);
        }        
        
        // 
        for (PlanPostPago listaPlan : ListaPPClaro) {                        
    ...
    private void initComponents() {
        ...
        jSpinner1.setModel(new javax.swing.SpinnerListModel(new String[] {"Claro MAX 99", "Claro MAX 149", "Claro MAX 189"}));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jSpinner1, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(26, 26, 26)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
